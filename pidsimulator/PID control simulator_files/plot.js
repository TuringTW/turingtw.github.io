...
this.drawGraphLinear = function() { 
  ...
  if (this.seriesIdx > 0) 
	...
	if (this.enumerateV) {
      ...
      var x = this.seriesIdx * 30;
      ctx.fillText(Math.round((range[1]-i*nrSpacing)*this.dataTrimmer)/this.dataTrimmer,x,(i+1)*spacVertic-this.fSize*0.5+3);
		}
	}
  ...
  ctx.font = "15px Arial";
  //ctx.fillStyle = "black";
  ctx.fillText(this.seriesName,50,15 + 20 * this.seriesIdx);          
}
...
this.plot= function() {
  ...
  if (this.seriesIdx == 0) this.drawGrid();
